...
CURRENCY_PAIRS: List[str] = [
    'USDJPY','USDCHF','USDCAD','EURUSD','EURGBP','EURJPY','EURCHF','EURCAD','EURAUD','EURNZD','GBPUSD','GBPJPY','GBPCHF','GBPCAD','GBPAUD','GBPNZD','CHFJPY','CADJPY','CADCHF','AUDUSD','AUDJPY','AUDCHF','AUDCAD','AUDNZD','NZDUSD','NZDJPY','NZDCHF','NZDCAD',
    'USDJPY.Z','USDCHF.Z','USDCAD.Z','EURUSD.Z','EURGBP.Z','EURJPY.Z','EURCHF.Z','EURCAD.Z','EURAUD.Z','EURNZD.Z','GBPUSD.Z','GBPJPY.Z','GBPCHF.Z','GBPCAD.Z','GBPAUD.Z','GBPNZD.Z','CHFJPY.Z','CADJPY.Z','CADCHF.Z','AUDUSD.Z','AUDJPY.Z','AUDCHF.Z','AUDCAD.Z','AUDNZD.Z','NZDUSD.Z','NZDJPY.Z','NZDCHF.Z','NZDCAD.Z'
]
