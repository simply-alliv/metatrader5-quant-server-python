...
PRIMARY_TIMEFRAME = MT5Timeframe.H4 # Timeframe for trend analysis (higher timeframe)
ENTRY_TIMEFRAME = MT5Timeframe.M30   # Timeframe for entry signals (lower timeframe)
...
TP_LEVEL_MULTIPLIER = 1.5          # Example: Take Profit level multiplier based on Fibonacci range
